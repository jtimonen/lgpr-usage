...
This vignette demonstrates how to use the `lgpr` package to generate artificial longitudinal data with a disease component and fit differents models to for it. 
